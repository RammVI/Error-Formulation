...
def main_Adj(name , dens , input_suffix , output_suffix , percentaje ,  N ,  N_ref ,
             smooth = False , refine = True, Use_GAMer = False , sphere=False):
...
txt_name = 'Resultados_24_08_2020_E_u_tolerance_test.txt'
...
if True:
    ...
    if True:
        ...
        if True:
            ...
            for i in suffixes[:-1]:
                ...
                text = '{0} & {1:f} & {2:d}'.format( molecule, dens , N_Ref  )
                ...
                ( S_trad , S_Ap , S_Ex , N_elements , N_El_adj , tot_solving_time , S_trad_time , S_Ap_time ,
                  S_Ex_time , op_time_U , assem_time_U , solv_time_U , it_count_U )  = main_Adj( 
                    ...
                    N=25 , N_ref=N_Ref , smooth = True , refine = True, Use_GAMer = True)
    ...
    Resultados.write('Exact solution mesh with uniform refinement: Enabled with N_REF=0 \n')
    Resultados.write('CHANGED TOLERANCE OF U TO 1E-5 \n')
    Resultados.close()
