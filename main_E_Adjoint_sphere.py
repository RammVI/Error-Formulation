...
txt_name = '_Resultados_Uniform_Refinement.txt'
...
if True:
    ...
    main_Adj(name , dens , '-s0' , '-s1' , percentaje=2.5 , r=r , x_q=x_q , q=q , N=25, N_ref=1 , smooth = True ,
            ...
            for i in suffixes[1:-1]:
                ...
                ( S_trad , S_Ap , S_Ex , N_elements , N_El_adj , tot_solving_time , S_trad_time , S_Ap_time ,
                  S_Ex_time , op_time_U , assem_time_U , solv_time_U , it_count_U )  = main_Adj( 
                    ...
                    N=25 , N_ref=1, smooth = True , refine = True, Use_GAMer = True , sphere=True)
    ...
    Resultados.write('1 refinement on phi grid - E_phi \n')
    Resultados.close()
