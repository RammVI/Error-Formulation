    ...
    for molecule in ('arg' , 'methanol'):
        for dens in ( 0.5 , 1.0 , 2.0 , 4.0 , 5.0 , 12.5):            
            ...
            for suffix in instance[:-1]:
                ...
                S_trad , S_Cooper , S_Zeb , N_elements, fin_time , ref_time = main( molecule , dens , instance[c_r] , instance[c_r+1] , 0.1,
                                                                                  smooth=True)
